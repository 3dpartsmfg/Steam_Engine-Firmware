...
// Calculated using 4.7kohm pullup, voltage divider math, and manufacturer provided temp/resistance
   {1*OVERSAMPLENR, 969},
   {54*OVERSAMPLENR, 270},
   {107*OVERSAMPLENR, 219},
   {160*OVERSAMPLENR, 192},
   {213*OVERSAMPLENR, 174},
   {266*OVERSAMPLENR, 159},
   {319*OVERSAMPLENR, 147},
   {372*OVERSAMPLENR, 137},
   {425*OVERSAMPLENR, 128},
   {478*OVERSAMPLENR, 120},
   {531*OVERSAMPLENR, 111},
   {584*OVERSAMPLENR, 104},
   {637*OVERSAMPLENR, 96},
   {690*OVERSAMPLENR, 88},
   {743*OVERSAMPLENR, 80},
   {796*OVERSAMPLENR, 72},
...
const short temptable_6[][2] PROGMEM = {
   ...
   {160*OVERSAMPLENR, 188},
   {213*OVERSAMPLENR, 170},
   {266*OVERSAMPLENR, 156},
   {319*OVERSAMPLENR, 144},
   {372*OVERSAMPLENR, 134},
